...
const navigationOptions: Array<BottomNavigationBarOptions> = [
  { label: "Bounty Board", value: "/app", icon: <ScrollTextIcon /> },
  { label: "Profile", value: "/app/profile", icon: <UserIcon /> },
  { label: "Hall of Fame", value: "/app/hall-of-fame", icon: <TrophyIcon /> },
]
